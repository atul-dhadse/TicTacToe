...
def inputPlayerLetter():
    #lets the player type which letter they eant to be.
    #Returns a list with the player's letter as the first 
    # itme and the computer's letter as the second.
    letter = ""
...
def isWinner(bo, le):
    ...
    #we use "bo" instead of "board" and "le" instead of letters

    return((bo[7] == le and bo[8] == le and bo[9] == le ) or 
            (bo[4] == le and bo[5] == le and bo[6] == le  ) or 
            (bo[1] == le and bo[2] == le and bo[3] == le  ) or 
            (bo[7] == le and bo[4] == le and bo[1] == le  ) or 
            (bo[8] == le and bo[3] == le and bo[2] == le  ) or 
...
def getComputerMove(board, computerLetter):
    ...
    #Try to take corners, if they are free.
